...
//ol.proj.get("EPSG:32718").setExtent([655633.702429, 5916885.930077, 701103.193775, 5939620.675750]);
var wms_layers = [];
...
lyr_Barrios_2.set('fieldAliases', {'Id': 'Id', 'Nombre': 'Nombre', });
...
lyr_Barrios_2.set('fieldImages', {'Id': 'Range', 'Nombre': 'TextEdit', });
...
lyr_Barrios_2.set('fieldLabels', {'Id': 'no label', 'Nombre': 'no label', });
